...
public class Reserva extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String s2 = request.getParameter("nombre");
           String s3 = request.getParameter("email");
           String s4 = request.getParameter("llegada");
           String s5 = request.getParameter("Salida");
           String s6 = request.getParameter("person");
           String s7 = request.getParameter("asientos");
     ...
     Connection  con = DriverManager.getConnection("jdbc:mysql://localhost:3306/aerolinea","root" ,"mysql2018");
      ...
      Statement  st =  con.createStatement();
       ...
       int rs =  st.executeUpdate("insert into aeroliena.reserva (cname,email,arrival_date,departure_date,person,room,uid)values ('"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"','"+s7+"')");
         // out.println(s1);
         // out.println(s2);
