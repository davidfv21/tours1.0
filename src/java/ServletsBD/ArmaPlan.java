 ...
 * @author Daniela
 */
public class ArmaPlan extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String s1 = request.getParameter("name");
           ...
           String s7 = request.getParameter("nino");
     ...
     Connection  con = DriverManager.getConnection("jdbc:mysql://localhost:3306/aerolinea","root" ,"mysql2018");
      ...
      Statement  st =  con.createStatement();
        ...
        int rs =  st.executeUpdate("insert into aerolinea.armaplan(name,email,cel,pais,ciudad,nadultos,nninos,comment) values ('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"','"+s7+"','"+s8+"')");
