    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("conncetion successfull");
                ...
                ResultSet rs =   st.executeQuery("select email,uid, pass from aerolinea.registro where email = '"+s1+"' and pass = '"+s2+"'");
                rs.next();    
         ...
         out.println("<a href=\"Inicio.jsp\">Check Output Page Here </a>");
          ...
          response.sendRedirect("LoginSucess.jsp");
            ...
            out.println("Usuario no encontrado" +e);
