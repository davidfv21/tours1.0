    ...
    <body>
     ...
     Connection  con = DriverManager.getConnection("jdbc:mysql://localhost:3306/aerolinea","root" ,"mysql2018");
      ...
      //    out.println("conncetion successfull");
       ...
       ResultSet rs = st.executeQuery("select * from aerolinea.reserva where uid = "+n);%>
        ...
        <%  while(rs.next())
        {
          ...
          //  out.println(id);
           ...
           // out.println(cname);
            ...
            String arrival  = rs.getString("llegada");
            String departure  = rs.getString("salida");
            int person  = rs.getInt("person");
            int room  = rs.getInt("asientos");
            ...
            <div class="hotel-block"  style="background-color: #5882FA;padding: 2px 15px 30px;margin-top: -20px; width: 102%; margin-left: -23px;">
                ...........................................................................................................................................................................................................................................................................................
                <h2 class="heading"><label style=" margin-left: 150px; margin-top: 151px;">Nombre :</label><span  style=" margin-left: 200px;"><%out.println(cname);%></h2> 
                <h2 class="heading"><label style="margin-left: 150px;">Email :</label><span  style=" margin-left: 200px;"><%out.println(email);%></span></h3> 
                <h2 class="heading"><label style="margin-left: 150px;">Fecha Llegada :</label><span  style=" margin-left: 100px;"><%out.println(arrival);%></h2>
                <h2 class="heading"><label style="margin-left: 150px;">Fecha Salida:</label><span  style=" margin-left: 50px;"><%out.println(departure);%></h2> 
                <h2 class="heading"><label style="margin-left: 150px;">Nº de personas :</label><span  style=" margin-left: 70px;"><%out.println(person);%></h2>
                <h2 class="heading"><label style="margin-left: 150px;">Nº de Asientos :</label><span  style=" margin-left: 100px;"><%out.println(room);%></h2> 
