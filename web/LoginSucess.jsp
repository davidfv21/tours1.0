   ...
   <%@ include file="header.jsp" %> 
    ...
    <body>
       ...
       out.println("driver loaded");
        ...
        ResultSet rs =st.executeQuery("select name ,email from aerolinea.registro where uid ="+n);
        out.println(rs);
        rs.next();
        ...
        <h2 class="heading" style="  padding-bottom: 50px;"><% out.println("Bienvenido :    " +s1);%></h2>
     ...
     padding-top: 20px;">
          ...
          <a href="Armaplan.jsp">  <h2 class="heading" style=" margin-left: 100px; padding-top: 10px; background-color:  #08088A; width: 200px;height: 40px; box-shadow: 10px 10px 5px #888888;">Reservar ya</h2>
          ...
          <a href="Planes.jsp">  <h2 class="heading" style=" margin-left: 100px; padding-top: 10px; background-color:  #08088A; width: 200px;height: 40px; box-shadow: 10px 10px 5px #888888;">reservado</h2>
